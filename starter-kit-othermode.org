...
#+begin_src emacs-lisp
  ...
  (if (eq window-system 'x)
      (shell-command (concat "test ! -f " starter-kit-src-directory
                             "trac-wiki.el && "
                             "wget --quiet https://raw.github.com/tiborsimko/trac-wiki-el/master/trac-wiki.el --directory-prefix=" starter-kit-src-directory)))
#+end_src
