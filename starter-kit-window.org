...
#+BEGIN_SRC emacs-lisp
  ...
  (defun sk-solarized-childtheme ()
    (let* ((solarized-fg (if (eq variant 'light) s-base00 "#CCCCCC"))
           (solarized-bg (if (eq variant 'light) s-base3 "#1A1A1A"))
      ...
      (custom-theme-set-faces
       ...
       `(mode-line           ((,class (:foreground ,modeline-fg
                                                   :background ,blue :box nil))))
       `(mode-line-inactive  ((,class (:foreground ,modeline-fg
                                                   :background ,blue-d :box nil))))
       `(mode-line-buffer-id ((,class (:foreground ,modeline-fg :box nil))))
