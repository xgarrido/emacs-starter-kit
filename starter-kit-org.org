...
*** KOMA/LaTeX script
The following code mainly comes from a [[http://lists.gnu.org/archive/html/emacs-orgmode/2010-07/msg01060.html][thread]] on org-mode mailing list.
#+begin_src emacs-lisp
  (add-to-list 'org-export-latex-classes
               '("koma-letter"
...
following piece of code try to solve this (orginal idea from [[http://lists.gnu.org/archive/html/emacs-orgmode/2009-10/msg00044.html][EricSchulte]]). There
can be some problems if another org->latex file has a =\closing= word since
this fix is added to all org-to-latex export (through the final hook).
#+begin_src emacs-lisp
