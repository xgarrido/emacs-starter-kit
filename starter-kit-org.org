...
#+BEGIN_SRC emacs-lisp
  (defun org-fold-get-fold-info-file-name ()
    (let (fold-directory (concat temporary-file-directory "org-fold/"))
      unless (file-exists-p fold-directory)
      (make-directory fold-directory)
      (concat fold-directory (buffer-name) ".fold")))
